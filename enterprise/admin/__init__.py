...
from enterprise.utils import (
    ...
    get_enterprise_catalog_preview_url,
    get_all_field_names,
...
class EnterpriseCustomerAdmin(DjangoObjectActions, SimpleHistoryAdmin):
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        if catalog_uuid:
            enterprise_catalog_url = get_enterprise_catalog_preview_url(catalog_uuid, html_format=False)
            return HttpResponseRedirect(enterprise_catalog_url)
...
class EnterpriseCatalogQueryAdmin(admin.ModelAdmin):
    ...
    def preview_catalog_url(self, obj):
        ...
        """
        return get_enterprise_catalog_preview_url(obj.uuid)
